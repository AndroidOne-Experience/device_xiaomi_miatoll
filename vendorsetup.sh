...
# Vendor tree
git clone -b 15-old https://github.com/AndroidOne-Experience/vendor_xiaomi_miatoll.git vendor/xiaomi/miatoll --depth=1

# Kernel tree
git clone -b 15 https://github.com/AndroidOne-Experience/kernel_xiaomi_sm6250.git kernel/xiaomi/sm6250 --depth=1
